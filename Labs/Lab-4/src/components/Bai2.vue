    ...
    <div class="container mt-4">
        ...
        <form @submit.prevent="addBook">
            ...
            <div class="mb-3">
                ...
                <input type="number" :value="bookQuantity" @input="bookQuantity = $event.target.value"
                    class="form-control" id="bookQuantity" placeholder="Nhập số lượng" @keyup.enter.prevent="addBook" />
            </div>
